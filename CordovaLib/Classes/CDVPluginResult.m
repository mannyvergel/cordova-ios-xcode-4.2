...
id messageFromArrayBuffer(NSData* data)
{
  ...
  return [NSDictionary dictionaryWithObjectsAndKeys:@"CDVType" , @"ArrayBuffer",
          @"data" ,[data base64EncodedString], nil ];
}
...
id messageFromMultipart(NSArray* theMessages)
{
  ...
  return [NSDictionary dictionaryWithObjectsAndKeys:@"CDVType" , @"MultiPart",
...
{
  NSDictionary* errDict = [NSDictionary dictionaryWithObjectsAndKeys:@"code",[NSNumber numberWithInt:errorCode], nil];/*@{@"code" :[NSNumber numberWithInt:errorCode]};*/
